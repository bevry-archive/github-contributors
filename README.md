...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/getcontributors/^2.15.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/getcontributors@^2.15.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/getcontributors@2.15.0'
</script>
```
